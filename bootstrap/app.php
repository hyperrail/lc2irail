...
$app->singleton(
    App\Http\Repositories\LinkedConnectionsRepositoryContract::class,
...
$app->singleton(
    App\Http\Repositories\VehicleRepositoryContract::class,
    App\Http\Repositories\VehicleRepository::class
);
